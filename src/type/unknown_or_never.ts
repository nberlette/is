 ...
 * @see https://jsr.io/@nick/is/doc/type/unknown-or-never
 */
 ...
 * @example
 * ```ts
 * import type { IsUnknownOrNever } from "jsr:@nick/is/type";
 *
 ...
 * @example
 * ```ts
 * import type { OmitUnknownOrNever } from "jsr:@nick/is/type";
 *
